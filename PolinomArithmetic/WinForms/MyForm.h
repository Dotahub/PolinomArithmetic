...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Text = L"Операции с полиномами";
			...
			this->label7->Text = L"Переменные вида: {x0,x1,x2,x3...xn}";
			// 
			// MyForm
			// 
