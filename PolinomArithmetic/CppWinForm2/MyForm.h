...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label5->Text = L"Переменные типа: x0 x1 x2 x3 x4 ... x9";
			// 
			// button1
			// 
			...
			this->button9->Text = L"Добавить 1 полином";
			...
			this->button10->Text = L"Добавить 2 полином";
			...
			this->button12->Text = L"Очистить 1 полином";
			...
			this->button13->Text = L"Очистить 2 полином";
...
#pragma endregion
		int maxst; int num;//максимальная степень и число переменных
		CircleList *p1,*p2,*res;//якобы полиномы
		int k1,k2;//коэффициенты для умножения
		Polinom *pol1, *pol2, *pres;
private: System::Void button4_Click(System::Object^  sender, System::EventArgs^  e) {
	string vvod;
	System::String^ s = textBox1->Text;
	vvod = SysToStd(s);
	if ((vvod == "") || (vvod == "Введите чонибудь"))
	{
		vvod = "Введите чонибудь";
		s = StdToSys(vvod);
		textBox1->Text = s;
	}
	else
	...
	vvod2 = SysToStd(s2);
	if ((vvod2 == "") || (vvod2 == "Введите чонибудь"))
	{
		vvod2 = "Введите чонибудь";
		s2 = StdToSys(vvod2);
		textBox2->Text = s2;
	}
	else
